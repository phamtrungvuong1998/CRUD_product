<aside class="left-panel">
            ...
            <div class="user text-center">
                  <img src="{base_url()}public/images/avtar/user.png" class="img-circle" alt="...">
            ...
            <nav class="navigation">
            	<ul class="list-unstyled">
                	<li class="active"><a href="/danh-sach-san-pham/1"><i class="fa fa-bookmark-o"></i><span class="nav-label">Danh sách sản phẩm</span></a></li>
                    <li class="has-submenu"><a href="/them-san-pham"><i class="fa fa-comment-o"></i> <span class="nav-label">Thêm sản phẩm</span></a>
                    </li>
