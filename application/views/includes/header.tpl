                	...
                	<div class="dropdown-menu md arrow pull-right panel panel-default arrow-top-right messages-dropdown">
                        ...
                        <div class="list-group">
                            ...
                            <div class="media">
                              ...
                              <img class="media-object img-circle pull-left" src="<?=base_url()?>public/images/avtar/user2.png" alt="user#1" width="40">
                              </div>
                            ...
                            <div class="media">
                              ...
                              <img class="media-object img-circle pull-left" src="<?=base_url()?>public/images/avtar/user3.png" alt="user#1" width="40">
                              </div>
                              <div class="media-body">
                            ...
                            <div class="media">
                              ...
                              <img class="media-object img-circle pull-left" src="<?=base_url()?>public/images/avtar/user4.png" alt="user#1" width="40">
                              </div>
                              <div class="media-body">
                            ...
                            <div class="media">
                              ...
                              <img class="media-object img-circle pull-left" src="<?=base_url()?>public/images/avtar/user5.png" alt="user#1" width="40">
                              </div>
                              <div class="media-body">
